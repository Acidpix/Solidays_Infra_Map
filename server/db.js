...
db.transaction(() => {
  for (const t of [
    ...
    { id:'a5', category:'ap',   name:'Échecs de connexion', metric:'connFailure', op:'>', threshold:0,  unit:'',  severity:'warn', enabled:1 },
    { id:'w4', category:'wave', name:'Température élevée',   metric:'temp',        op:'>', threshold:60, unit:'°C', severity:'crit', enabled:1 },
    { id:'w5', category:'wave', name:'Consommation élevée',  metric:'power',       op:'>', threshold:80, unit:'W',  severity:'warn', enabled:0 },
    ...
    { id:'s4', category:'sw',   name:'Température élevée',    metric:'temp',    op:'>',  threshold:55, unit:'°C', severity:'warn', enabled:1 },
